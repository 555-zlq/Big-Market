package com.learn.test.domain.award;
...
/**
 * @author Carton
 * @date 2025/11/12 19:40
 * @description TODO: 奖品服务测试
 */
@Slf4j
...
public class AwardServiceTest {
    ...
    public void test_saveUserAwardRecord() throws InterruptedException {
        for (int i = 0; i < 20; i++) {
            ...
            userAwardRecordEntity.setUserId("carton");
            userAwardRecordEntity.setActivityId(100301L);
            userAwardRecordEntity.setStrategyId(10006L);
