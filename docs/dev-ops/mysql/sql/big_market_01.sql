...
INSERT INTO `raffle_activity_account` VALUES (1,'xiaofuge',100301,37,37,37,37,37,37,'2025-11-06 20:55:34','2025-11-11 00:02:43'),(2,'carton',100301,43,43,43,43,43,43,'2025-11-06 22:15:48','2025-11-24 23:21:19');
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='抽奖活动账户表-日次数';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `raffle_activity_account_day` VALUES (1,'carton',100301,'2025-11-10',38,36,'2025-11-10 23:54:41','2025-11-10 23:59:54'),(2,'carton',100301,'2025-11-11',38,35,'2025-11-11 10:25:47','2025-11-11 10:25:47'),(3,'carton',100301,'2025-11-13',38,29,'2025-11-13 23:20:25','2025-11-13 23:32:23'),(4,'carton',100301,'2025-11-17',10,2,'2025-11-17 16:20:40','2025-11-17 17:10:30'),(13,'carton',100301,'2025-11-18',38,32,'2025-11-18 21:59:44','2025-11-18 23:54:05');
...
INSERT INTO `raffle_activity_account_month` VALUES (1,'carton',100301,'2025-11',40,3,'2025-11-10 23:54:41','2025-11-24 23:21:19');
...
CREATE TABLE `raffle_activity_order_003` (
  ...
  UNIQUE KEY `uq_out_business_no` (`out_business_no`),
  KEY `idx_user_id_activity_id` (`user_id`,`activity_id`,`state`)
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='抽奖活动单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=255 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='任务表，发送MQ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_award_record_003` (
  ...
  KEY `idx_activity_id` (`activity_id`),
  KEY `idx_award_id` (`strategy_id`)
) ENGINE=InnoDB AUTO_INCREMENT=242 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户中奖记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_behavior_rebate_order_001` VALUES (5,'xiaofuge','630841674684','sign','签到返利-sku额度','sku','9011','20240503','xiaofuge_sku_20240503','2024-05-03 13:28:42','2024-05-03 13:28:42'),(6,'xiaofuge','552413408368','sign','签到返利-积分','integral','10','20240503','xiaofuge_integral_20240503','2024-05-03 13:28:42','2024-05-03 13:28:42');
...
INSERT INTO `user_behavior_rebate_order_003` VALUES (1,'carton','589561251941','sign','签到返利-sku额度','sku','9011','20251124','carton_sku_20251124','2025-11-24 23:21:18','2025-11-24 23:21:18'),(2,'carton','717508939618','sign','签到返利-积分','integral','10','20251124','carton_integral_20251124','2025-11-24 23:21:18','2025-11-24 23:21:18');
...
CREATE TABLE `user_raffle_order_003` (
  ...
  UNIQUE KEY `uq_order_id` (`order_id`),
  KEY `idx_user_id_activity_id` (`user_id`,`activity_id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户抽奖订单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-11-24 23:32:22
