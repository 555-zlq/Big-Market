...
INSERT INTO `raffle_activity_account` VALUES (1,'xiaofuge',100301,37,37,37,37,37,37,'2025-11-06 20:55:34','2025-11-11 00:02:43'),(2,'carton',100301,38,1,38,1,38,1,'2025-11-06 22:15:48','2025-11-18 23:54:05');
...
INSERT INTO `raffle_activity_account_month` VALUES (1,'carton',100301,'2025-11',38,1,'2025-11-10 23:54:41','2025-11-18 23:54:05');
...
) ENGINE=InnoDB AUTO_INCREMENT=241 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='任务表，发送MQ';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_behavior_rebate_order_003` (
  ...
  UNIQUE KEY `uq_biz_id` (`biz_id`),
  KEY `idx_user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户行为返利流水订单表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_behavior_rebate_order_003` VALUES (11,'carton','555245290713','sign','签到返利-sku额度','sku','9011','carton_sku_20251120','2025-11-20 17:17:10','2025-11-20 17:17:10'),(12,'carton','735031367229','sign','签到返利-积分','integral','10','carton_integral_20251120','2025-11-20 17:17:10','2025-11-20 17:17:10');
...
-- Dump completed on 2025-11-20 22:34:34
