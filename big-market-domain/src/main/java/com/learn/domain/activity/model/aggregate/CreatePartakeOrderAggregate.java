package com.learn.domain.activity.model.aggregate;


import com.learn.domain.activity.model.entity.ActivityAccountDayEntity;
import com.learn.domain.activity.model.entity.ActivityAccountEntity;
import com.learn.domain.activity.model.entity.ActivityAccountMonthEntity;
...
/**
 * @author Carton
 * @date 2025/11/10 21:49
 * @description TODO:  参与活动订单聚合对象
 */
@Data
@Builder
@AllArgsConstructor
